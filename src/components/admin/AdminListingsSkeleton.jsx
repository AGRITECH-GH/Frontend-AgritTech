    ...
    <>
      ...
      <div className="overflow-x-auto rounded-2xl border border-border/60 bg-white shadow-sm">
        <div className="min-w-[1040px]">
          <div className="grid grid-cols-[90px_1.6fr_1.2fr_1fr_1fr_1fr_1fr_1fr] gap-3 border-b border-border bg-surface/60 px-4 py-3">
          ...
          {Array.from({ length: 7 }).map((_, index) => (
            <div
              key={index}
              className="grid grid-cols-[90px_1.6fr_1.2fr_1fr_1fr_1fr_1fr_1fr] items-center gap-3 border-b border-border/50 px-4 py-3"
            >
