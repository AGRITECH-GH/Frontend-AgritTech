...
import { useInventory, PRODUCT_CATEGORIES, PRODUCT_UNITS } from "@/hooks/useInventory";
  ...
  return (
    <div className="min-h-screen bg-surface">
      <main className="container py-6 lg:py-8">
        ...
        {/* Page Header */}
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-foreground">Add New Farm Product</h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6 grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                />
                {errors.expectedHarvestDate && (
                  <p className="mt-1 text-xs text-red-500">{errors.expectedHarvestDate}</p>
                )}
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    step="0.01"
                    min="0"
                    className={`w-full rounded-lg border px-3 py-2 pl-6 text-sm transition focus:outline-none ${
                      errors.pricePerUnit
                        ? "border-red-500 focus:border-red-500 focus:ring-1 focus:ring-red-500"
                        : "border-border focus:border-primary focus:ring-1 focus:ring-primary/20"
                    }`}
                ...
                {errors.pricePerUnit && (
                  <p className="mt-1 text-xs text-red-500">{errors.pricePerUnit}</p>
                )}
              </div>
            </div>
            ...
            <div className="mb-6 grid gap-6 md:grid-cols-3">
              ...
              <div>
                ...
                />
                {errors.storageLocation && (
                  <p className="mt-1 text-xs text-red-500">{errors.storageLocation}</p>
                )}
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center justify-center rounded-lg border-2 border-dashed border-border bg-surface/50 px-6 py-12 transition hover:border-primary hover:bg-surface">
                <div className="text-center">
                  ...
                  <p className="text-xs text-muted">or click to browse from your files</p>
